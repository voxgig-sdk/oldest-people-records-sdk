...
(0, node_test_1.describe)('OldestLivingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OldestPeopleRecordsSDK({
    ...
    (0, node_test_1.test)('direct-load-oldest_living', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-oldest_living', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OLDEST_PEOPLE_RECORDS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OldestPeopleRecordsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OLDEST_PEOPLE_RECORDS_TEST_OLDEST_LIVING_ENTID'];
    ...
    const client = new __1.OldestPeopleRecordsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OldestLivingDirect.test.js.map