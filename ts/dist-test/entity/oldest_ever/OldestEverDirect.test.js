...
(0, node_test_1.describe)('OldestEverDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-oldest_ever', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-oldest_ever', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OLDEST_PEOPLE_RECORDS_TEST_OLDEST_EVER_ENTID'];
...
//# sourceMappingURL=OldestEverDirect.test.js.map