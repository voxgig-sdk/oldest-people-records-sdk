...
(0, node_test_1.describe)('OldestEverEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/oldest_ever/OldestEverTestData.json');
    ...
    let idmap = transform(['oldest_ever01', 'oldest_ever02', 'oldest_ever03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['OLDEST_PEOPLE_RECORDS_TEST_OLDEST_EVER_ENTID'];
...
//# sourceMappingURL=OldestEverEntity.test.js.map