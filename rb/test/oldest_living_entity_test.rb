...
class OldestLivingEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OLDESTPEOPLERECORDS_TEST_OLDEST_LIVING_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def oldest_living_basic_setup(extra)
  ...
  entid_env_raw = ENV["OLDESTPEOPLERECORDS_TEST_OLDEST_LIVING_ENTID"]
