...
#      offline in seeded test mode (OldestPeopleRecordsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OldestPeopleRecords_sdk.rb")
  SDK_CLASS = "OldestPeopleRecordsSDK"
  ...
  SDK_BASE = "OldestPeopleRecords_sdk"
