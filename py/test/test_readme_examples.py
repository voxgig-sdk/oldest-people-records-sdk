# OldestPeopleRecords SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OldestPeopleRecordsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OldestPeopleRecordsSDK(...) and OldestPeopleRecordsSDK.test(...) become
#      OldestPeopleRecordsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "oldestpeoplerecords_sdk"
_SDK_CLASS = "OldestPeopleRecordsSDK"
...
_ENTITIES = {
    "OldestEver": "oldest_ever",
    "OldestLiving": "oldest_living",
}
