...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.OldestEver()` — each
carrying a small, uniform set of operations (`load`, `update`) instead of raw URL
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/oldest-people-records-sdk/releases)) or
...
```
py/
├── oldestpeoplerecords_sdk.py         -- Main SDK module
...
The main module (`oldestpeoplerecords_sdk`) exports the SDK class.
