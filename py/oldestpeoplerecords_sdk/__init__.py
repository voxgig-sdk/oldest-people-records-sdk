...
from oldestpeoplerecords_sdk.utility import register

# Load features
from oldestpeoplerecords_sdk.feature.base_feature import OldestPeopleRecordsBaseFeature
from oldestpeoplerecords_sdk.features import _has_feature, _make_feature
...
class OldestPeopleRecordsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OldestPeopleRecordsUtility()
    ...
    def get_utility(self):
        return OldestPeopleRecordsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OldestPeopleRecordsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def OldestEver(self, data=None) -> "OldestEverEntity":
        ...
        from oldestpeoplerecords_sdk.entity.oldest_ever_entity import OldestEverEntity
    ...
    def OldestLiving(self, data=None) -> "OldestLivingEntity":
        ...
        from oldestpeoplerecords_sdk.entity.oldest_living_entity import OldestLivingEntity
