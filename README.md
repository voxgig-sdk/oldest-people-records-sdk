...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/oldest-people-records` | `npm install @voxgig-sdk/oldest-people-records` |
| Python | `voxgig-sdk-oldest-people-records` | `pip install voxgig-sdk-oldest-people-records` |
| PHP | `voxgig-sdk/oldest-people-records` | `composer require voxgig-sdk/oldest-people-records` |
| Golang | `github.com/voxgig-sdk/oldest-people-records-sdk/go` | `go get github.com/voxgig-sdk/oldest-people-records-sdk/go` |
| Ruby | `voxgig-sdk-oldest-people-records` | `gem install voxgig-sdk-oldest-people-records` |
| Lua | `voxgig-sdk-oldest-people-records` | `luarocks install voxgig-sdk-oldest-people-records` |
