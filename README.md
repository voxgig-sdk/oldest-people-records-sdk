...
This API provides information about the oldest living person and the oldest person ever recorded.

Learn more about Oldest People Records API at [whoistheoldest.com](https://whoistheoldest.com).
...
This SDK exposes the API as a small set of **semantic entities** — OldestEver and OldestLiving — that you
...
The operations available across these entities are **load**, **update** — see each entity's
