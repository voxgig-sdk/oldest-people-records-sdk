# OldestPeopleRecords SDK feature corpus test
#
...
def _client(kase):
    ...
    OldestPeopleRecordsSDK(...), not OldestPeopleRecordsSDK.test(...): the `test` feature is
    ...
    return OldestPeopleRecordsSDK(opts)
