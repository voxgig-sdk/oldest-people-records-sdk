...
from projectname_sdk import OldestPeopleRecordsSDK
from projectname_sdk.core.spec import OldestPeopleRecordsSpec
from projectname_sdk.core.result import OldestPeopleRecordsResult
from projectname_sdk.core.response import OldestPeopleRecordsResponse
from projectname_sdk.core.operation import OldestPeopleRecordsOperation
from projectname_sdk.core.error import OldestPeopleRecordsError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return OldestPeopleRecordsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except OldestPeopleRecordsError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = OldestPeopleRecordsResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = OldestPeopleRecordsSDK.test(None, None)
        ...
        class TestInitFeature(OldestPeopleRecordsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OldestPeopleRecordsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = OldestPeopleRecordsSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = OldestPeopleRecordsSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OldestPeopleRecordsSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OldestPeopleRecordsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OldestPeopleRecordsSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = OldestPeopleRecordsOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OldestPeopleRecordsSDK.test(None, setup_opts)
