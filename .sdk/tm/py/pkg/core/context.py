...
from projectname_sdk.core.control import OldestPeopleRecordsControl
...
class OldestPeopleRecordsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OldestPeopleRecordsControl()
        ...
        if isinstance(sp, OldestPeopleRecordsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OldestPeopleRecordsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OldestPeopleRecordsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return OldestPeopleRecordsOperation({})
        ...
        op = OldestPeopleRecordsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return OldestPeopleRecordsError(code, msg, self)
