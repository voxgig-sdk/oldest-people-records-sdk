...
// OldestPeopleRecords SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OldestPeopleRecordsOmni::makeStructRunner(
    ...
    {
        return OldestPeopleRecordsOmni::objmodel(OldestPeopleRecordsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return OldestPeopleRecordsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return OldestPeopleRecordsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OldestPeopleRecordsOmni::structfix($now, Struct::undef()))
                        !== json_encode(OldestPeopleRecordsOmni::structfix($val, Struct::undef()))) {
