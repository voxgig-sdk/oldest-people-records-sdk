...
// OldestPeopleRecords SDK utility: fetcher

class OldestPeopleRecordsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OldestPeopleRecordsSDK/1.0)';
    ...
    public static function call(OldestPeopleRecordsContext $ctx, string $fullurl, array $fetchdef): array
    {
