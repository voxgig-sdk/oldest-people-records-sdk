...
class OldestPeopleRecordsTestFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    public function init(OldestPeopleRecordsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OldestPeopleRecordsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = OldestPeopleRecordsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OldestPeopleRecordsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OldestPeopleRecordsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = OldestPeopleRecordsParam::call($ctx, $k);
