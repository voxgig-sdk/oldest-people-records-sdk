...
// OldestPeopleRecords SDK proxy feature
...
class OldestPeopleRecordsProxyFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    public function init(OldestPeopleRecordsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OldestPeopleRecordsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
