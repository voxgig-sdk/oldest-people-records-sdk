...
// OldestPeopleRecords SDK debug feature
...
class OldestPeopleRecordsDebugFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _finish(OldestPeopleRecordsContext $ctx, bool $ok): void
    {
