...
// OldestPeopleRecords SDK rbac feature
...
class OldestPeopleRecordsRbacFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _required(OldestPeopleRecordsContext $ctx): ?string
    {
    ...
    private function _reject(OldestPeopleRecordsContext $ctx, string $required): void
    {
    ...
    private function _track(OldestPeopleRecordsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
