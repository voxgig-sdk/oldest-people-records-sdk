...
// OldestPeopleRecords SDK telemetry feature
...
class OldestPeopleRecordsTelemetryFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _close(OldestPeopleRecordsContext $ctx, bool $ok): void
    {
