...
// OldestPeopleRecords SDK streaming feature
...
class OldestPeopleRecordsStreamingFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _iterate(OldestPeopleRecordsResult $result): \Generator
    {
    ...
    private function _streamable(OldestPeopleRecordsContext $ctx): bool
    {
