...
// OldestPeopleRecords SDK cache feature
...
class OldestPeopleRecordsCacheFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _through(OldestPeopleRecordsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
