...
// OldestPeopleRecords SDK ratelimit feature
...
class OldestPeopleRecordsRatelimitFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _acquire(OldestPeopleRecordsContext $ctx): void
    {
    ...
    private function _track(OldestPeopleRecordsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
