...
|---|---|---|
| `ts/` | @voxgig-sdk/oldest-people-records-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/oldest-people-records-sdk \
      --repository voxgig-sdk/oldest-people-records-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/oldest-people-records-sdk` shows it, and
`npm trust revoke @voxgig-sdk/oldest-people-records-sdk --id=<id>` removes it.
