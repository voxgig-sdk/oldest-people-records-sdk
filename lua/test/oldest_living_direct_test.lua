...
describe("OldestLivingDirect", function()
  it("should direct-load-oldest_living", function()
    local setup = oldest_living_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-oldest_living", setup.live and "live" or "unit")
...
function oldest_living_direct_setup(mockres)
