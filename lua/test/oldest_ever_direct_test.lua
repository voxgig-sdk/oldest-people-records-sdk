...
describe("OldestEverDirect", function()
  it("should direct-load-oldest_ever", function()
    local setup = oldest_ever_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-oldest_ever", setup.live and "live" or "unit")
...
function oldest_ever_direct_setup(mockres)
