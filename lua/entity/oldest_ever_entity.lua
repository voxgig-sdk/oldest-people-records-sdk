...
local OldestEverEntity = {}
OldestEverEntity.__index = OldestEverEntity


function OldestEverEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OldestEverEntity)
  self._name = "oldest_ever"
  self._client = client
...
function OldestEverEntity:get_name()
  return self._name
end


function OldestEverEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OldestEverEntity.new(self._client, opts)
end
...
function OldestEverEntity:mark_deleted()
  self._deleted = true
end


function OldestEverEntity:deleted()
  return true == self._deleted
end


function OldestEverEntity:data_set(args)
  if args ~= nil then
...
function OldestEverEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OldestEverEntity:match_set(args)
  if args ~= nil then
...
function OldestEverEntity:match_get()
...
function OldestEverEntity:stream(action, args, callopts)
...
---@param reqmatch OldestEverLoadMatch
---@param ctrl? table
---@return OldestEver
---@return string? err
function OldestEverEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OldestEverUpdateData
---@param ctrl? table
---@return OldestEver
---@return string? err
function OldestEverEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OldestEverEntity:_run_op(ctx, post_done)
  local utility = self._utility
