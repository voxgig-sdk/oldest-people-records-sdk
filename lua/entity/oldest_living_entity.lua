-- OldestPeopleRecords SDK OldestLiving entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OldestLivingEntity = {}
OldestLivingEntity.__index = OldestLivingEntity


function OldestLivingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OldestLivingEntity)
  self._name = "oldest_living"
  self._client = client
...
function OldestLivingEntity:get_name()
  return self._name
end


function OldestLivingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OldestLivingEntity.new(self._client, opts)
end
...
function OldestLivingEntity:mark_deleted()
  self._deleted = true
end


function OldestLivingEntity:deleted()
  return true == self._deleted
end


function OldestLivingEntity:data_set(args)
  if args ~= nil then
...
function OldestLivingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OldestLivingEntity:match_set(args)
  if args ~= nil then
...
function OldestLivingEntity:match_get()
...
function OldestLivingEntity:stream(action, args, callopts)
...
function OldestLivingEntity:_run_op(ctx, post_done)
  local utility = self._utility
