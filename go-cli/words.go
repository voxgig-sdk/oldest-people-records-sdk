...
func registerSDKWords(r *eng.Registry, client *sdk.OldestPeopleRecordsSDK) {
...
func runOp(client *sdk.OldestPeopleRecordsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
