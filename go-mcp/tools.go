...
type Args struct {
	Entity string         `json:"entity" jsonschema:"oldest_ever | oldest_living"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OldestPeopleRecordsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "oldest-people-records_list",
		Description: "List records from OldestPeopleRecords. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "oldest-people-records_load",
		Description: "Load a single record from OldestPeopleRecords. " +
...
func runOp(client *sdk.OldestPeopleRecordsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OldestPeopleRecordsSDK, name string) (sdk.OldestPeopleRecordsEntity, error) {
	switch strings.ToLower(name) {
	case "oldest_ever":
		return client.OldestEver(nil), nil
	case "oldest_living":
		return client.OldestLiving(nil), nil
