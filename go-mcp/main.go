// Command OldestPeopleRecords-mcp is an MCP server exposing the OldestPeopleRecords
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OldestPeopleRecords_list  — list records of an entity
//	OldestPeopleRecords_load  — load a single record of an entity
//
