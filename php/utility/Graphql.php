...
// OldestPeopleRecords SDK utility: graphql
//
...
class OldestPeopleRecordsGraphql
{
    ...
    // equivalent.
    public static function body(OldestPeopleRecordsContext $ctx): mixed
    {
    ...
    public static function errors(OldestPeopleRecordsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
