...
// OldestPeopleRecords SDK utility type

class OldestPeopleRecordsUtility
{
    ...
    public static function copy(OldestPeopleRecordsUtility $src): OldestPeopleRecordsUtility
    {
        $u = new OldestPeopleRecordsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
