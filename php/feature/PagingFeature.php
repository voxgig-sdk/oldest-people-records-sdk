...
// OldestPeopleRecords SDK paging feature
...
class OldestPeopleRecordsPagingFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _is_list(OldestPeopleRecordsContext $ctx): bool
    {
