...
// OldestPeopleRecords SDK timeout feature
...
class OldestPeopleRecordsTimeoutFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _with_timeout(OldestPeopleRecordsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OldestPeopleRecordsContext $_ctx, float $ms): void
    {
        $client = $this->client;
