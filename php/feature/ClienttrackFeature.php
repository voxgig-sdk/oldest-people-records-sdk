...
// OldestPeopleRecords SDK clienttrack feature
...
class OldestPeopleRecordsClienttrackFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    public function PostConstruct(OldestPeopleRecordsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OldestPeopleRecords-SDK';
