...
// OldestPeopleRecords SDK netsim feature
...
class OldestPeopleRecordsNetsimFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _simulate(OldestPeopleRecordsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OldestPeopleRecordsContext $ctx, array $applied): void
    {
        $client = $this->client;
