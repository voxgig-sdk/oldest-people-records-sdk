...
// OldestPeopleRecords SDK audit feature
...
class OldestPeopleRecordsAuditFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _emit(OldestPeopleRecordsContext $ctx, string $outcome): void
    {
