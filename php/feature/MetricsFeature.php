...
// OldestPeopleRecords SDK metrics feature
...
class OldestPeopleRecordsMetricsFeature extends OldestPeopleRecordsBaseFeature
{
    ...
    private function _record(OldestPeopleRecordsContext $ctx, bool $ok): void
    {
