...
// OldestPeopleRecords SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OldestPeopleRecordsSDK::test)
...
{
    private const SDK_CLASS = 'OldestPeopleRecordsSDK';
    ...
    private const SDK_BASE = 'oldestpeoplerecords_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../oldestpeoplerecords_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
