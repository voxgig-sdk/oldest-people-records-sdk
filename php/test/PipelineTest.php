...
// OldestPeopleRecords SDK pipeline test
//
...
{
    private static function utility(): OldestPeopleRecordsUtility
    {
        return new OldestPeopleRecordsUtility();
    }
    ...
    private static function ctx(array $over = []): OldestPeopleRecordsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OldestPeopleRecordsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OldestPeopleRecordsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OldestPeopleRecordsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OldestPeopleRecordsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OldestPeopleRecordsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OldestPeopleRecordsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OldestPeopleRecordsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OldestPeopleRecordsResponse([]),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        [, $err] = OldestPeopleRecordsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec([]),
            'response' => null,
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        [, $err] = OldestPeopleRecordsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec(['step' => 's']),
            'response' => new OldestPeopleRecordsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        [, $err] = OldestPeopleRecordsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec(['step' => 's']),
            'response' => new OldestPeopleRecordsResponse(self::resp(200, ['v' => 1])),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        [, $err] = OldestPeopleRecordsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec(['step' => 's']),
            'response' => new OldestPeopleRecordsResponse(self::resp(200, ['v' => 2])),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OldestPeopleRecordsMakeResponse::call($ctx);
    ...
    {
        $preset = new OldestPeopleRecordsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec([]),
            'response' => new OldestPeopleRecordsResponse([]),
            'result' => new OldestPeopleRecordsResult([]),
        ...
        [$got, $err] = OldestPeopleRecordsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OldestPeopleRecordsResult([])]);
        [, $err] = OldestPeopleRecordsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OldestPeopleRecordsSpec([]), 'result' => null]);
        [, $err] = OldestPeopleRecordsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OldestPeopleRecordsSpec(['step' => 's']),
            'result' => new OldestPeopleRecordsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OldestPeopleRecordsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OldestPeopleRecordsSpec(['step' => 's']),
            'result' => new OldestPeopleRecordsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OldestPeopleRecordsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OldestPeopleRecordsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OldestPeopleRecordsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OldestPeopleRecordsSpec([]),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OldestPeopleRecordsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OldestPeopleRecordsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OldestPeopleRecordsError('boom', 'boom');
        $utility->fetcher = function (OldestPeopleRecordsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OldestPeopleRecordsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OldestPeopleRecordsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OldestPeopleRecordsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OldestPeopleRecordsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OldestPeopleRecordsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OldestPeopleRecordsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OldestPeopleRecordsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OldestPeopleRecordsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OldestPeopleRecordsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OldestPeopleRecordsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OldestPeopleRecordsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OldestPeopleRecordsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OldestPeopleRecordsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OldestPeopleRecordsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OldestPeopleRecordsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OldestPeopleRecordsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OldestPeopleRecordsResult(['ok' => false])]);
        $this->expectException(OldestPeopleRecordsError::class);
        OldestPeopleRecordsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OldestPeopleRecordsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OldestPeopleRecordsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OldestPeopleRecordsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OldestPeopleRecordsBaseFeature();
        $b = new OldestPeopleRecordsBaseFeature();
        OldestPeopleRecordsFeatureAdd::call($ctx, $a);
        OldestPeopleRecordsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OldestPeopleRecordsBaseFeature
    {
        $f = new OldestPeopleRecordsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OldestPeopleRecordsFeatureAdd::call($ctx, self::named_feature('a'));
        OldestPeopleRecordsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        OldestPeopleRecordsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        OldestPeopleRecordsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        OldestPeopleRecordsFeatureAdd::call($ctx, $replace);
        ...
        OldestPeopleRecordsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OldestPeopleRecordsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OldestPeopleRecordsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OldestPeopleRecordsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OldestPeopleRecordsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OldestPeopleRecordsResponse(['headers' => null]),
            'result' => new OldestPeopleRecordsResult([]),
        ]);
        OldestPeopleRecordsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OldestPeopleRecordsResultBody::call($ctx);
