...
class OldestLivingDirectTest extends TestCase
{
    public function test_direct_load_oldest_living(): void
    {
        $setup = oldest_living_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-oldest_living", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
