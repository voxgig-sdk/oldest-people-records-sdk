# OldestPeopleRecords Golang SDK



The Golang SDK for the OldestPeopleRecords API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/oldest-people-records-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/oldest-people-records-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/oldest-people-records-sdk/go=../oldest-people-records-sdk/go
```
...
All entities implement the `OldestPeopleRecordsEntity` interface.
...
```
github.com/voxgig-sdk/oldest-people-records-sdk/go/
├── oldest-people-records.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/oldest-people-records-sdk/go`) re-exports everything needed
