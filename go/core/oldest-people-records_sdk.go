...
type OldestPeopleRecordsSDK struct {
	Mode     string
...
func (sdk *OldestPeopleRecordsSDK) OptionsMap() map[string]any {
...
func (sdk *OldestPeopleRecordsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OldestPeopleRecordsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OldestPeopleRecordsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OldestPeopleRecordsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OldestPeopleRecordsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OldestPeopleRecordsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OldestPeopleRecordsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OldestPeopleRecordsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OldestPeopleRecordsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OldestPeopleRecordsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OldestPeopleRecordsSDK {
	if sdkopts == nil {
	...
	sdk := NewOldestPeopleRecordsSDK(sdkopts)
	sdk.Mode = "test"
