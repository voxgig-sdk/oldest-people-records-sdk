...
func (e *OldestLivingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OldestLivingEntity) Deleted() bool {
	return e.deleted
}
...
func (e *OldestLivingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
