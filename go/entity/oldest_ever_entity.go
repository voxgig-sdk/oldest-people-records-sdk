...
func NewOldestEverEntity(client *core.OldestPeopleRecordsSDK, entopts map[string]any) *OldestEverEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OldestEverEntity) GetName() string { return e.name }
...
func (e *OldestEverEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OldestEverEntity) Deleted() bool {
	return e.deleted
}


func (e *OldestEverEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOldestEverEntity(e.client, opts)
}

func (e *OldestEverEntity) Data(args ...any) any {
...
func (e *OldestEverEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *OldestEverEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OldestEverEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OldestEverEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *OldestEverEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *OldestEverEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OldestEverEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
