...
const testSeed = `map[string]any{"entity": map[string]any{"oldest_ever": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oldest_living": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
